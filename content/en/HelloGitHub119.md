...
### Java
11、[jquick-curl](https://hellogithub.com/en/periodical/statistics/click?target=https://github.com/dromara/jquick-curl)：Java Library for Directly Running curl Commands.This is a lightweight HTTP client Java library that can directly convert curl commands into executable HTTP request logic in Java without manual code rewriting. It is suitable for quickly integrating into Java projects after copying curl commands from Chrome browser developer tools, API documents, etc.Shared by [@paohaijiao](https://hellogithub.com/en/user/iIaNjn0mSdwx6gv)
```java
